...
Projekt pytigon-gui jest częścią większego projektu Pytigon, który napisany jest głównie w python, korzysta z Django. Szablony django zostały zastąpione przez szablony .ihtml. Cechą harakterystyczną tych szablonów jest to, że bazują na wcięciach kodu i są kompilowane do szablonów django.
