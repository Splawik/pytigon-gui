...
Provides a simple username/password dialog for application authentication.
"""
...
class LoginDialog(wx.Dialog):
    """Modal dialog for user login with username and password fields.

    Usage::

        dlg = LoginDialog(parent, wx.ID_ANY, "Login")
    ...
    def __init__(
        ...
        Args:
            ...
            username: Default username to pre-fill (optional).
        """
